...
class AccountInfoWidget extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    return asyncAccountInfo.when(data: (data) {
      return Row(
    ...
    }, error: (error, stackTrace) => Center(child: Text(error.toString()),), loading: () => const Center(child: SpinKitCircle(size: 20, color: Colors.red,),),);
  }

  void _showCustomModelBottomSheet({ required BuildContext context, required WidgetRef ref }) {
            ...
            InkWell(
              onTap: () async {
                ...
                if(file != null) {
                  ...
                  await ref.read(asyncAccountProvider.notifier).changeAvatar(file);
                  context.pop();
                }
              },
              child: const ListTile(
